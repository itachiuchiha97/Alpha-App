...
"resource": {
  ...
  "tags":[{
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cdiv class=\"cookies-widget\"\u003E\n\t\t\u003Cdiv class=\"cookies-widget__text\"\u003E\n\t\t\t\tWe use cookies and local storage for better UX (such as your collections), extra powers for the paid users, analytics, and ads. \u003Ca href=\"https:\/\/icons8.com\/privacy-policy\" target=\"_blank\" class=\"cookies-widget__link\"\u003EPrivacy Policy\u003C\/a\u003E\n\t\t\u003C\/div\u003E\n\t\u003Cdiv class=\"cookies-widget__close\"\u003E×\u003C\/div\u003E\n\u003C\/div\u003E\n\n\u003Cstyle\u003E\n\/* ------------- cookies-widget-------------  *\/\n  \n.cookies-widget {\n\tdisplay: none;\n\topacity: 0;\n\tposition: fixed;\n\tbottom: 0;\n\tleft: 0;\n\tright: 0;\n\tbackground-color: #333;\n\tpadding: 5px 10px;\n\tbox-shadow: 0 11px 15px -7px rgba(0, 0, 0, 0.2), 0 24px 38px 3px rgba(0, 0, 0, 0.14), 0 9px 46px 8px rgba(0, 0, 0, 0.12);\n\tbox-sizing: border-box;\n\t-webkit-transition-duration: 0.3s;\n\ttransition-duration: 0.3s;\n\t-webkit-animation-duration: 0.3s;\n\tanimation-duration: 0.3s;\n\t-webkit-animation-fill-mode: forwards;\n\tanimation-fill-mode: forwards;\n\tz-index: 11;\n}\n\n.cookies-widget.is-active {\n\t-webkit-animation-name: anim-open;\n\tanimation-name: anim-open;\n}\n\n.cookies-widget.is-hide {\n\t-webkit-animation-name: anim-close;\n\tanimation-name: anim-close;\n}\n\n.cookies-widget__text {\n\tcolor: white;\n\tfont-family: -apple-system, BlinkMacSystemFont, 'San Francisco', 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', 'Segoe UI', 'Fira Sans', Roboto, Oxygen, Ubuntu, 'Droid Sans', 'Arial', sans-serif;\n\tfont-size: 16px;\n\tfont-weight: 400;\n\tpadding-right: 30px;\n}\n\n.cookies-widget__link {\n  color: #fff;\n  text-decoration: none;\n  border-bottom: 1px solid rgba(255, 255, 255, 0.5);\n  transition: 0.2s;\n}\n\n.cookies-widget__link:hover {\n  border-bottom: 1px solid rgba(255, 255, 255, 0);\n}  \n  \n.cookies-widget__close {\n\tposition: absolute;\n\ttop: 50%;\n\tright: 10px;\n\tmargin-top: -9px;\n\theight: 16px;\n\twidth: 16px;\n\tcolor: white;\n\tcursor: pointer;\n}\n  @-webkit-keyframes anim-open {\n\t0% {\n\t\topacity: 0;\n\t\t-webkit-transform: translate3d(0, 50px, 0);\n\t}\n\n\t100% {\n\t\topacity: 1;\n\t\t-webkit-transform: translate3d(0, 0, 0);\n\t}\n}\n\n@keyframes anim-open {\n\t0% {\n\t\topacity: 0;\n\t\t-webkit-transform: translate3d(0, 50px, 0);\n\t\ttransform: translate3d(0, 50px, 0);\n\t}\n\n\t100% {\n\t\topacity: 1;\n\t\t-webkit-transform: translate3d(0, 0, 0);\n\t\ttransform: translate3d(0, 0, 0);\n\t}\n}\n\u003C\/style\u003E\n\n\u003Cscript type=\"text\/gtmscript\"\u003Evar cookiesWidget={id:\"cookies-europe\",container:document.querySelector(\".cookies-widget\"),closeButton:document.querySelector(\".cookies-widget__close\"),show:function(){cookiesWidget.container.style.display=\"block\";setTimeout(function(){cookiesWidget.container.classList.add(\"is-active\")},300)},hide:function(){cookiesWidget.container.classList.remove(\"is-active\");cookiesWidget.container.classList.add(\"is-hide\");setTimeout(function(){cookiesWidget.container.style.display=\"none\"},400);localStorage.setItem(\"cookiesWidget\",\ncookiesWidget.id)},isEnabled:function(){return localStorage.getItem(\"cookiesWidget\")!==cookiesWidget.id}};cookiesWidget.isEnabled()\u0026\u0026(cookiesWidget.closeButton.addEventListener(\"click\",cookiesWidget.hide),cookiesWidget.show());\u003C\/script\u003E",
      ...
      "function":"__html",
      "once_per_event":true,
      "vtp_html":"\u003Cscript async data-gtmsrc=\"\/\/pagead2.googlesyndication.com\/pagead\/js\/adsbygoogle.js\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003E(adsbygoogle=window.adsbygoogle||[]).push({google_ad_client:\"ca-pub-3732773600888178\",enable_page_level_ads:!0});\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":16
  ...
  "rules":[
    [["if",0,2],["unless",1],["add",0,2]],
    [["if",2],["unless",3,4],["add",1]],
    [["if",2],["unless",4,5],["add",3]],
    [["if",2],["unless",4,6],["add",4]],
    [["if",2],["unless",7,8,9],["add",5]],
    [["if",2],["add",6,8]],
    [["if",2],["unless",10,11,12,13],["add",7]],
    [["if",2,14],["add",9]]]
},
"runtime":[
[],[]
...
return!a},ff=function(){var a=ef();try{var b=yc.m,c=f["GTMDataLayer"].hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}}catch(g){}return a},gf=function(){var a=Oa("GTMDataLayer",[]),b=Oa("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};Jd(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Ye(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||
...
Nh=function(a,b){if(Oe()){b&&z(b)}else Sa(a,b)},Oh=function(a){return!!Qf(a,"init",!1)},Ph=function(a){Of(a,"init",!0)},Qh=function(a,b,c){var d=(void 0===c?0:c)?"www.googletagmanager.com/gtag/js":Cc;d+="?id="+encodeURIComponent(a)+"&l=GTMDataLayer";b&&ra(b,function(e,g){g&&(d+="&"+e+"="+encodeURIComponent(g))});H(D("https://","http://",d))};
